...
const BASE_ENV = { MLFLOW_TRACKING_URI: "http://x:5000" };

const SCENARIOS = [
  { label: "default", env: {} },
  { label: "narrow (experiments,runs)", env: { MLFLOW_TOOLS: "experiments,runs" } },
  { label: "typical (experiments,runs,registry,traces)", env: { MLFLOW_TOOLS: "experiments,runs,registry,traces" } },
];
